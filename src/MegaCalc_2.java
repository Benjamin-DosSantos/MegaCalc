...
public class MegaCalc_2 {
	...
	public static void promptUser(){
		...
		double number_1, number_2;
		 switch (input) {
         	case 1:  input = 1;
         		number_1 = getNumber("Please enter the first number to add.");
         		number_2 = getNumber("Please enter the second number to add.");
         		System.out.println(number_1 + " + " + number_2 + " = " + addNumbers(number_1, number_2));  
         		break;
         	case 2:  input = 2;
         		number_1 = getNumber("Please enter the first number to subtract.");
         		number_2 = getNumber("Please enter the second number to subtract.");
         	 	System.out.println(number_1 + " - " + number_2 + " = " + subtractNumbers(number_1, number_2));
                break;
         	case 3:  input = 3;
         		System.out.println();
         		number_1 = getNumber("Please enter the first number to devide.");
         		number_2 = getNumber("Please enter the second number to devide.");
         		System.out.println(number_1 + " / " + number_2 + " = " + divideNumbers(number_1, number_2));
                break;
         	case 4:  input = 4;
         		number_1 = getNumber("Please enter the first number to multiply.");
         		number_2 = getNumber("Please enter the second number to multiply.");
         		System.out.println(number_1 + " * " + number_2 + " = " + multiplyNumbers(number_1, number_2));
         		break;
         	case 5:  input = 5;
         		number_1 = getNumber("Please enter a number to find to square root of.");
         		System.out.println("The square root of " + number_1 + " is " + squareRoot(number_1));
                break;
         	case 6:  input = 6;
         		number_1 = getNumber("Please enter the first number to be a base.");
         		number_2 = getNumber("Please enter the second number to use as a exponent.");
         		System.out.println(number_1 + " to the power of " + number_2 + " = " + powerOfNumbers(number_1, number_2));
     			break;
         	case 7:  input = 7;
         		number_1 = getNumber("Please enter the first number to sign.");
         		System.out.println("The sign of " + number_1 + " is " + sineNumber(number_1));
                break;
         	case 8:  input = 8;
         		number_1 = getNumber("Please enter the adjacent number as the first Cosine number.");
         		number_2 = getNumber("Please enter the hypotenuse to use as the second Cosine number.");
         		System.out.println("The Cosine of " + number_1 + " and " + number_2 + " = " + CosineNumber(number_1, number_2));
                break;
         	case 9:  input = 9;
         		number_1 = getNumber("Please enter a number to find the tangent of.");
         		System.out.println("The Tangent of " + number_1 + " = " + tangentOfNumbers(number_1));
                break;
         	case 10:  input = 10;
         		number_1 = getNumber("Please enter a number to find the factorial of.");
         		System.out.println("The factorial of " + number_1 + " = " + factorialOfNumber(number_1));
                break;
         	case 11: input = 11;
         		number_1 = getNumber("Please enter a number to reverse.");
